...
import '../alternatives/alternative1.dart';
import '../tasks/tasks1.dart';
import '../tasks/tasks2.dart';

class Tasks1Check extends StatefulWidget {
  final task;
  final task_image;

  Tasks1Check({this.task, this.task_image});
  @override
  _Tasks1CheckState createState() => _Tasks1CheckState();
}

class _Tasks1CheckState extends State<Tasks1Check> {
  final List_Item = [
    {

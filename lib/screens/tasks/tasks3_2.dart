...
import 'package:newapp/screens/tasks/tasks3_2_0.dart';

class Tasks3_2 extends StatefulWidget {
  final List<Color> ColorList;

  Tasks3_2({required this.ColorList});
  @override
  _Tasks3_2State createState() => _Tasks3_2State();
}

class _Tasks3_2State extends State<Tasks3_2> {
  final List_Item = [
    {
...
class Product3_2 extends StatelessWidget {
  final product_image;
  final task;
  final task_color;

  Product3_2({this.product_image, this.task, this.task_color});
  @override
  Widget build(BuildContext context) {
    return Card(
      child: Hero(
            ...
            onTap: () {
              if (task == 2) {
                Navigator.of(context).push(MaterialPageRoute(
                    ...
                    builder: (context) => Tasks3_2_0(ColorList: [
                          Colors.yellow,
                          Colors.yellow,
                          Colors.yellow,
                          Colors.yellow,

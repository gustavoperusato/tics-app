...
import 'package:newapp/screens/tasks/tasks3_1_0.dart';

import '../../widgets/taskIncorrect.dart';
// import 'package:newapp/screens/tasks/tasks3_1_0.dart';

class Tasks3_1 extends StatefulWidget {
  final List<Color> ColorList;

  Tasks3_1({required this.ColorList});
  @override
  _Tasks3_1State createState() => _Tasks3_1State();
}

class _Tasks3_1State extends State<Tasks3_1> {
  final List_Item = [
    {
...
class Product3_1 extends StatelessWidget {
  final product_image;
  final task;
  final task_color;

  Product3_1({this.product_image, this.task, this.task_color});
  @override
  Widget build(BuildContext context) {
    return Card(
      child: Hero(
            ...
            onTap: () {
              if (task == 1) {
                Navigator.of(context).push(MaterialPageRoute(
                    ...
                    builder: (context) => Tasks3_1_0(ColorList: [
                          Colors.yellow,
                          Colors.yellow,
                          Colors.yellow,
                          Colors.yellow,
